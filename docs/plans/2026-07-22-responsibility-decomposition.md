...
| PR 4: Knowledge separation | Ready for delivery from `main@8f76a74` | graph facade 85 lines and SQLite facade 64 lines; 41 focused and 452 full-suite tests pass at 90.5% branch coverage; canonical output parity, offline wheel, and three real-Docker probes pass |
